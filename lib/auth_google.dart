...
import 'package:login/auth.services.dart';
    ...
    return Scaffold(
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            StreamBuilder(
              stream: authServices.onGoogleCurrentUserChange,
              ...
              builder:
                ...
                if (snapshot.hasData) {
                  return SignInButtonBuilder(
                    ...
                    icon: Icons.email,
                    onPressed: () async {
                      await authServices.signOutFirebase();
                    },
                ...
                return SignInButtonBuilder(
                  ...
                  icon: Icons.email,
                  onPressed: () async {
                    await authServices.signInFirebase(
